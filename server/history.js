...
// Security audit emits three series per run (v0.59): crit/warn/info
// finding counts. Internally generated by server/security-audit.js,
// not accepted via /api/metrics ingestion.
const SECURITY_METRIC_PATTERN = /^security\.(crit|warn|info)_count$/;
